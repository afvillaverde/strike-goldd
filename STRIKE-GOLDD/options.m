...
modelname ='2DOF_2unknown_inputs';    % Name of a .mat file placed in the 'models' folder 
...
opts.nnzDerW    = [2,2];       % In FISPO and ORC-DF, numbers of nonzero derivatives of the unmeasured inputs (w); may be 'inf'
