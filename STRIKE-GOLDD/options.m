...
opts.affine_delete_model   = 1;     % delete affine_model.mat at the end (=1) or not (=0).
...
opts.multiexp_user_nnzDerU = 0;    % Set manually the number of nonzero derivatives of the measured inputs (u) for each experiment (=1) or not (=0).
opts.multiexp_user_nnzDerW = 0;    % Set manually the number of nonzero derivatives of the unmeasured inputs (w) for each experiment (=1) or not (=0).
opts.multiexp_nnzDerU      = [0 0 0]; % Number of nonzero derivatives of the measured inputs (u) for each experiment; may be 'inf'.
opts.multiexp_nnzDerW      = [0 0 0]; % Number of nonzero derivatives of the unmeasured inputs (w) for each experiment; may be 'inf'.
