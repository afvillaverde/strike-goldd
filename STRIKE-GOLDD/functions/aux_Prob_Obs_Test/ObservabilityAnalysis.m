...
function [p_id,  p_un, obs_states, unobs_states, obs_inputs, unobs_inputs,meas_x] = ObservabilityAnalysis(X,Theta,ObservabilityMatrix,p,n,l,nwl,h,u)
...
if trnsdeg==0
    ...
    fprintf('\n >>> The model is not observable, identifiable or reconstructible:');
    for i=1:l
